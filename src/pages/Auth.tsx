...
import { Home, Eye, EyeOff, User, Building, Briefcase, Shield, Wrench, TrendingUp, Calendar } from "lucide-react";
...
const Auth = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Auth submission - Role:', selectedRole);
  };
  ...
  const handleRoleSelection = (roleValue: string) => {
    ...
    // Auto-trigger the select component to show the selection
